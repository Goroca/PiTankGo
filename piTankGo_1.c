...
int InicializaSistema(TipoSistema *p_sistema) {
	...
	InicializaEfecto(&p_sistema->player.efecto_Despacito,"DESPACITO",frecuenciaDespacito,tiempoDespacito,160);
	InicializaEfecto(&p_sistema->player.efecto_GOT,"GOT",frecuenciaGOT,tiempoGOT,518);
	InicializaEfecto(&p_sistema->player.efecto_Tetris,"TETRIS",frecuenciaTetris,tiempoTetris,55);
	InicializaEfecto(&p_sistema->player.efecto_Starwars,"STARWARS",frecuenciaStarwars,tiempoStarwars,59);
